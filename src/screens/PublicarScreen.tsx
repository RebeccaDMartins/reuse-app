...
export default function PublicarScreen() {
  ...
  return (
    <ScreenScaffold
      title="Publicar item"
      subtitle="Adicione fotos, descreva e defina as condições."
    >
      <View
        accessible
        accessibilityLabel="Área para adicionar foto do item"
        style={[styles.hero, { marginBottom: 12 }]}
      >
      ...
      <View style={baseStyles.card}>
        <LabeledInput
          ...
          placeholder="Ex.: Livro de design"
        />
        <LabeledInput
          label="Descrição"
          value={desc}
